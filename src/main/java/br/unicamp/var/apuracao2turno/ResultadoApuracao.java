 ...
 * ou um candidato foi eleito por maioria absoluta, ou o processo segue para segundo turno entre os dois candidatos mais votados.
 */
public sealed interface ResultadoApuracao {
    ...
    /**
     * Resultado em que nenhum candidato atingiu maioria absoluta e o processo segue para segundo turno entre os dois mais votados.
     *
